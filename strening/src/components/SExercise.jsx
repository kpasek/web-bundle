...
export class SExercise extends Component {
  ...
  fetchData = async () => {
    const seriesRespone = await fetch(
      "https://api.kamilpasek.pl/api/schedule/series/e/" +
  ...
  handleDeleteSeries = async (seriesId) => {
    await fetch("https://api.kamilpasek.pl/api/schedule/series/" + seriesId, {
      method: "DELETE",
      mode: "cors",
      cache: "no-cache",
      credentials: "include",
  ...
  handleAdd = async (seriesId, fieldType) => {
    ...
    const putResult = await fetch(
      "https://api.kamilpasek.pl/api/schedule/series/" + seriesId,
      {
        method: "PUT",
        mode: "cors",
        cache: "no-cache",
  ...
  handleAddSeries = async () => {
    await fetch("https://api.kamilpasek.pl/api/schedule/series", {
      method: "POST",
      mode: "cors",
      cache: "no-cache",
      credentials: "include",
