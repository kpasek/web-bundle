...
export class RunTraining extends Component {
  ...
  async fetchData() {
    const response = await fetch(
      "https://api.kamilpasek.pl/api/schedule/trainings/start/" +
  ...
  handleChange = async (type, series, op) => {
    ...
    const seriesResponse = await fetch(
      "https://api.kamilpasek.pl/api/schedule/series/" +
  ...
  handleFinishTraining = async () => {
    ...
    await fetch("https://api.kamilpasek.pl/api/schedule/trainings/finish", {
      method: "POST",
      mode: "cors",
      cache: "no-cache",
      credentials: "include",
        ...
        <div className="container">
          <div className="row">
            <div className="col-12">
              <a href={"/?page_id=50&id=" + this.state.scheduleTrainingId}>
