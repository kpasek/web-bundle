...
export class Trainings extends Component {
  ...
  async fetchTrainingData() {
    const response = await fetch("https://api.kamilpasek.pl/api/trainings", {
      method: "GET",
      mode: "cors",
      cache: "no-cache",
      credentials: "include",
  ...
  handleNewTraining = async () => {
    ...
    await fetch("https://api.kamilpasek.pl/api/trainings", {
      method: "POST",
      mode: "cors",
      cache: "no-cache",
      credentials: "include",
  ...
  handleDeleteTraining = async (trainingId) => {
    await fetch("https://api.kamilpasek.pl/api/trainings/" + trainingId, {
      method: "DELETE",
      mode: "cors",
      cache: "no-cache",
      credentials: "include",
