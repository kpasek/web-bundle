...
export default class TrainingDetails extends Component {
  ...
  handleChangeExercise = async (exerciseId, order) => {
    ...
    await fetch(
      "https://api.kamilpasek.pl/api/exercises/change/" + exerciseId,
      {
        method: "POST",
        mode: "cors",
        cache: "no-cache",
  ...
  handleAddExercise = async () => {
    ...
    await fetch("https://api.kamilpasek.pl/api/trainings/exercise/add", {
      method: "POST",
      mode: "cors",
      cache: "no-cache",
      credentials: "include",
  ...
  handleDeleteExercise = async (exerciseId, order) => {
    await fetch("https://api.kamilpasek.pl/api/trainings/exercise/delete", {
      method: "DELETE",
      mode: "cors",
      cache: "no-cache",
      credentials: "include",
  ...
  fetchData = async () => {
    const response = await fetch(
      "https://api.kamilpasek.pl/api/exercises/training/" +
    ...
    const gotExercises = await fetch(
